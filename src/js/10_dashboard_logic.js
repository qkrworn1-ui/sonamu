...
window.renderVoteTeam = () => {
    ...
    if(uid === 'master') {
        ...
        const btnAttend = `<button onclick="window.castVoteTeam('attend', '${e.id}', '${e.dDate}')" class="${btnBase} ${myV==='attend' ? 'bg-blue-600 border-blue-600 text-white shadow-[0_4px_15px_rgba(37,99,235,0.4)] transform scale-[1.02]' : 'bg-white dark:bg-slate-800 border-blue-200 dark:border-blue-800/60 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-slate-700/60'}">${myV==='attend' ? checkIcon : '<div class="w-5 h-5 rounded-full border-[2.5px] border-blue-300 dark:border-blue-500/50 shrink-0"></div>'}<span>참석</span></button>`;
        const btnLate = `<button onclick="window.castVoteTeam('late', '${e.id}', '${e.dDate}')" class="${btnBase} ${myV==='late' ? 'bg-indigo-600 border-indigo-600 text-white shadow-[0_4px_15px_rgba(79,70,229,0.4)] transform scale-[1.02]' : 'bg-white dark:bg-slate-800 border-indigo-200 dark:border-indigo-800/60 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-slate-700/60'}">${myV==='late' ? clockIcon : '<div class="w-5 h-5 rounded-full border-[2.5px] border-indigo-300 dark:border-indigo-500/50 shrink-0"></div>'}<span>늦참</span></button>`;
        const btnAbsent = `<button onclick="window.castVoteTeam('absent', '${e.id}', '${e.dDate}')" class="${btnBase} ${myV==='absent' ? 'bg-red-500 border-red-500 text-white shadow-[0_4px_15px_rgba(239,68,68,0.4)] transform scale-[1.02]' : 'bg-white dark:bg-slate-800 border-red-200 dark:border-red-800/60 text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-slate-700/60'}">${myV==='absent' ? crossIcon : '<div class="w-5 h-5 rounded-full border-[2.5px] border-red-300 dark:border-red-500/50 shrink-0"></div>'}<span>불참</span></button>`;
        const btnPending = `<button onclick="window.castVoteTeam('pending', '${e.id}', '${e.dDate}')" class="${btnBase} ${myV==='pending' ? 'bg-amber-500 border-amber-500 text-white shadow-[0_4px_15px_rgba(245,158,11,0.4)] transform scale-[1.02]' : 'bg-white dark:bg-slate-800 border-amber-200 dark:border-amber-800/60 text-amber-500 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-slate-700/60'}">${myV==='pending' ? qIcon : '<div class="w-5 h-5 rounded-full border-[2.5px] border-amber-300 dark:border-amber-500/50 shrink-0"></div>'}<span>미정</span></button>`;
